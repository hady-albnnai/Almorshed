...
/// (`arena: true`) وهي ما يُحسب في لوحة الموسم (قرار ٦٥: تراكمي).
...
class XpEventType {
  ...
  /// نقاط تنافسية — تُحسب في لوحة الموسم (قرار ٦٠: التحديات هي الفاصل).
  /// **قرار ٦٥:** الترتيب تراكمي طوال الموسم ولا يُصفَّر أسبوعياً.
  final bool arena;
}
...
class XpLedgerService {
  ...
  /// نقاط التحديات فقط (قرار ٦٠) — ما يُحسب في لوحة الموسم (قرار ٦٥):
